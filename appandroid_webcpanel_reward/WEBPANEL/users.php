              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <p class="text-muted font-13 m-b-30">
                    Showing All Users. You can Search for the User.
                  </p>
 <?php
...
<?php
    ...
    function draw($user)
    {
        ...
        <tr>
            ...
            <td><a href="/admin/profile.php/?id=<?php echo $user['id']; ?>" class="btn btn-primary btn-xs"> View </a>  <a href="tracker.php?user=<?php echo $user['username']; ?>" class="btn btn-info btn-xs"><i class="fa fa-bar-chart-o"></i> Track Activity </a></td>
        </tr>
