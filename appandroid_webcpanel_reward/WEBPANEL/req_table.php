...
<a href="confirm_complete.php?id=<?php echo $data['rid'];?>" class="btn btn-info btn-xs"><i class="fa fa-check-square-o"></i> Mark as Complete</a>



<a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target=".bs-example-modal-sm<?php echo $data['rid'];?>"><i class="fa fa-trash-o"></i> Delete Request</a>
                  ...
                  <div class="modal-dialog modal-sm<?php echo $data['rid'];?>">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <p>Do you really want to delete the Request ??.</p>
                      <div class="modal-footer">
                        <button type="button" onclick="window.location.href='requests.php'" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        
<button type="button" onclick="window.location.href='confirm_delete.php?id=<?php echo $data['rid'];?>
