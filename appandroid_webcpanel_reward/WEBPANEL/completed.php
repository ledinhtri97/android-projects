     ...
     <li><a href="push.php" ><i class="fa fa-bullhorn"></i>Push Panel</a>
                ...
                <li><a><i class="fa fa-th-list"></i>Records <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="completed.php"><span>Completed</span></a>
                    </li>
                  </ul>
                </li>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <p class="text-muted font-13 m-b-30">
                    Showing All Completed Records. You can Delete a Record (or) Search for a Record.
                  </p>


<?php

 include_once('com_table.php');
